...
describe Paginator::Base do

  describe "takes minimum arguments current_page and number_of_pages" do
    before do
      @base = Paginator::Base.new(current_page: 10, number_of_pages: 50)
    end
  ...
  describe 'takes custom number_of_previous_pages' do
    before :each do
      @base = Paginator::Base.new(current_page: 15,
                                  number_of_pages: 50,
  ...
  describe "display method shows what pagination might look like" do
    it "handles first page" do
      base = Paginator::Base.new(current_page: 1,
                                  number_of_pages: 50,
    ...
    it "handles being exactly in the middle" do
      base = Paginator::Base.new(current_page: 4,
                                  number_of_pages: 7,
                                  number_of_previous_pages: 3,
                                  number_of_next_pages: 3)
    ...
    it "handles only having more" do
      base = Paginator::Base.new(current_page: 2,
                                  number_of_pages: 7,
                                  number_of_previous_pages: 3,
                                  number_of_next_pages: 3)
    ...
    it "handles only have less" do
      base = Paginator::Base.new(current_page: 7,
                                  number_of_pages: 7,
                                  number_of_previous_pages: 3,
                                  number_of_next_pages: 3)
